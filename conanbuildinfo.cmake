set(CONAN_GTEST_ROOT "C:/Users/jared/.conan/data/gtest/1.7.0/lasote/stable/package/c85f9b402dd4d46acdf074e1c63b768a41181d7a")
set(CONAN_INCLUDE_DIRS_GTEST "C:/Users/jared/.conan/data/gtest/1.7.0/lasote/stable/package/c85f9b402dd4d46acdf074e1c63b768a41181d7a/include")
set(CONAN_LIB_DIRS_GTEST "C:/Users/jared/.conan/data/gtest/1.7.0/lasote/stable/package/c85f9b402dd4d46acdf074e1c63b768a41181d7a/lib")
set(CONAN_BIN_DIRS_GTEST "C:/Users/jared/.conan/data/gtest/1.7.0/lasote/stable/package/c85f9b402dd4d46acdf074e1c63b768a41181d7a/bin")
...
set(CONAN_INCLUDE_DIRS "C:/Users/jared/.conan/data/gtest/1.7.0/lasote/stable/package/c85f9b402dd4d46acdf074e1c63b768a41181d7a/include" ${CONAN_INCLUDE_DIRS})
set(CONAN_LIB_DIRS "C:/Users/jared/.conan/data/gtest/1.7.0/lasote/stable/package/c85f9b402dd4d46acdf074e1c63b768a41181d7a/lib" ${CONAN_LIB_DIRS})
set(CONAN_BIN_DIRS "C:/Users/jared/.conan/data/gtest/1.7.0/lasote/stable/package/c85f9b402dd4d46acdf074e1c63b768a41181d7a/bin" ${CONAN_BIN_DIRS})
...
set(CONAN_CMAKE_MODULE_PATH "C:/Users/jared/.conan/data/gtest/1.7.0/lasote/stable/package/c85f9b402dd4d46acdf074e1c63b768a41181d7a" ${CONAN_CMAKE_MODULE_PATH})
...
macro(conan_define_targets)
    ...
    foreach(_LIBRARY_NAME ${CONAN_LIBS_GTEST})
        unset(FOUND_LIBRARY CACHE)
        find_library(FOUND_LIBRARY NAME ${_LIBRARY_NAME} PATHS ${CONAN_LIB_DIRS_GTEST} NO_DEFAULT_PATH)
        if(FOUND_LIBRARY)
            set(CONAN_FULLPATH_LIBS_GTEST ${CONAN_FULLPATH_LIBS_GTEST} ${FOUND_LIBRARY})
        else()
            message(STATUS "Library ${_LIBRARY_NAME} not found in package, might be system one")
            set(CONAN_FULLPATH_LIBS_GTEST ${CONAN_FULLPATH_LIBS_GTEST} ${_LIBRARY_NAME})
        endif()
    endforeach()

    add_library(CONAN_PKG::gtest INTERFACE IMPORTED)
    set_property(TARGET CONAN_PKG::gtest PROPERTY INTERFACE_LINK_LIBRARIES ${CONAN_FULLPATH_LIBS_GTEST} )
